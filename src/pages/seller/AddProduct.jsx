  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-2xl font-bold mb-4" style={{ color: 'rgb(var(--primary))' }}>Add New Product</h1>
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <button disabled={loading} className="w-full btn-primary disabled:opacity-60">{loading ? 'Adding...' : 'Add New Product'}</button>
          </div>
        </form>
      </div>
    </div>
